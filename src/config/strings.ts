...
const Strings = {
  ...
  EVENT_DELETE_ERROR: "Something went wrong while deleting event.",
  EVENT_NOT_FOUND: "Event not found!",
  EVENT_CREATED: "Event succesfully added!",
  EVENT_UPDATED: "Event succesfully updated!",
  EVENT_DELETED: "Event succesfully deleted!",
  ...
  EVENT_EMPTY_NEXT: "There are no upcoming events!",
  ...
  STUDENT_PASSWORD_UPDATED: "Password updated!",
  STUDENT_PASSWORD_UPDATE_ERROR: "Something went wrong while updating password.",
  STUDENT_PASSWORD_MISMATCH: "Passwords doesn't match!",
  STUDENT_PASSWORD_TOO_SHORT: "Password must be at least 8 characters!",
