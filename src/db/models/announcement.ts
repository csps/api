...
import { AnnouncementType } from "../../types/models";
...
class Announcement extends DatabaseModel{
  ...
  public static insert(announcement: AnnouncementType, callback: (error: ErrorTypes | null, announcement: Announcement | null) => void) {
    // Get database instance
    const db = Database.getInstance();
